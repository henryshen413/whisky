...
from whiskydatabase.views import  HomeView, WhiskyView, DistilleryMapView, WhiskyListView, BarMapView, DistilleryView
...
urlpatterns = [
    ...
    url(r'^distillery/(?P<distillery_slug>[-\w]+)/$', DistilleryView.as_view(), name='distillery_view')
